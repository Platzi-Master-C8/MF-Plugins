# Contributing to GH-Code Tracker
...
- Make sure you created an [Issue](https://github.com/platzily/platzily-ui/issues) related to it and you're following the [issues section](#Issues) recommendations
